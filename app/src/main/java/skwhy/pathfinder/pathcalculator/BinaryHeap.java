...
/**
 * Min-heap used by the A* pathfinder to efficiently retrieve the lowest-cost open node.
 * No Minecraft or Bukkit dependencies — pure Java.
 */
public class BinaryHeap {
    ...
    public Node insert(final Node node) {
        if (node.heapIdx >= 0) {
            throw new IllegalStateException("Node is already in the heap!");
        }
