...
public class BodyRotationControl implements Control {
    ...
    public void clientTick() {
        ...
        } else if (Math.abs(this.mob.yHeadRot - this.lastStableYHeadRot) > 15.0F) {
            this.headStableTime = 0;
            this.lastStableYHeadRot = this.mob.yHeadRot;
    ...
    private void rotateHeadTowardsFront() {
        ...
        float faceForwardFraction = Math.clamp(timeSinceStartingToFaceForward / 10.0F, 0.0F, 1.0F);
        ...
        this.mob.yBodyRot = Mth.rotateIfNecessary(this.mob.yBodyRot, this.mob.yHeadRot,
                angleRemainingUntilFacingForward);
    }
